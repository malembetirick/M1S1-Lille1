...
public class ValidationCroisee {
    ...
    private String positivePath, negativePath;
     ...
     */
    public ValidationCroisee ( TweetPool tweetPool, CrossValidable classifier, int nbFolds ) {
        this.tweetPool = tweetPool;
        this.classifier = classifier;
        this.nbFolds = nbFolds;
    }
    public ValidationCroisee(String positivePath, String negativePath, CrossValidable classifier, int nbfolds){
